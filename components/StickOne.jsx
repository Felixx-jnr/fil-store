...
const StickOne = () => {
  return (
    <section className="bg-fixed mt-16 h-[800px] text-white home-stick">
      <div className="flex flex-col justify-center items-center mx-auto w-[90%] lg:w-[60%] h-full">
        ...
        <p className="my-6 overflow-x-scroll font-semibold text-sm md:text-xl text-center leading-tight overf">
